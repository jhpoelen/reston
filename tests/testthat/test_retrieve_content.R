...
test_that("content can be retrieved from internet archive", {
  con <- retrieve_content("hash://sha256/c253a5311a20c2fc082bf9bac87a1ec5eb6e4e51ff936e7be20c29c8e77dee55")
