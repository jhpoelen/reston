...
version_history_iter <- function(retrieve, queryHash = first_version_query_hash()) {
  query_hash <- first_version_query_hash()

  nextEl <- function() {
    candidate_version <- retrieve(query_hash)
